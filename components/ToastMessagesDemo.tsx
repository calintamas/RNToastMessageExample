...
export type ToastMessagesDemoProps = {
  toastNestingLevel: ToastProps["nestingLevel"];
};

function ToastMessagesDemo({ toastNestingLevel }: ToastMessagesDemoProps) {
    ...
    <ScrollView>
      <View style={{ padding: 16 }}>
        <View style={styles.toggle}>
          ...
          <Switch
            value={autoHide}
            onValueChange={() => setAutoHide((prev) => !prev)}
          />
        </View>
        <View style={styles.toggle}>
        ...
        <View style={styles.buttonsContainer}>
          <Text>Nesting level 0</Text>
          <Button
            title="Show 1-line toast message"
            onPress={() =>
              LevelsToast.show({
                ...commonProps,
                text1: "This toast has one line."
              })
            }
          />
          <Button
            ...
            onPress={() =>
              LevelsToast.show({
                ...commonProps,
                delay: 1000,
                text1: "This toast waited 1 second to show."
              })
            }
          />
          <Button
            ...
            onPress={() =>
              LevelsToast.show({
                ...commonProps,
                text1:
                  "Toasts can have both a title and subtitle. This is the title.",
                text2:
          ...
          />
          <Button
            title="Show a native Modal screen & toast message inside"
            onPress={() => {
      ...
      <BottomSheetModal
        ...
        defaultPadding
        toastNestingLevel={toastNestingLevel}>
        <Button onPress={dismissBottomModal} title="Close" />
        <Text style={styles.modalMessage}>
          This modal will show, and the toast will still show over top! This is
          because BottomSheetModal also has a Toast instance within its Modal
          component, and the lib knows when to show a toast in a modal instance
          instead of the main app instance in ToastContainer. 🙌
        </Text>
      </BottomSheetModal>
    </ScrollView>
  );
